...
class HttpService {
  ...
  Future<String> fileUpload(XFile image) async {
    ...
    var multipartFile = await http.MultipartFile.fromPath('files', image.path, contentType: MediaType(mimeTypeData![0], mimeTypeData[1]));
  ...
  //회원가입2
  Future<CustomersResModel> customers(String _id, String phone, String address, String address2, String gender, String birth, String postcode, String identityVerificationId) async {
